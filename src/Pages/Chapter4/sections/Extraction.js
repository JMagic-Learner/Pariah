    ...
    <div>
      ...
      <div className="flex-ns mb4">
        ...
        <div className="w-50-ns pl3-ns">
          ...
          <ul className="lh-copy pl3 tj">
            <li className="pv1">
              <strong className="dark-red">+8 VP</strong> — Extractor: VIP
              reaches Extraction Zone
            </li>
            <li className="pv1">
              <strong className="dark-red">+2 VP</strong> — Extractor: Destroy
              enemy Commander MSU
            </li>
            <li className="pv1">
              <strong className="dark-red">+6 VP</strong> — Interceptor: VIP
              Marker is destroyed
            </li>
            <li className="pv1">
              <strong className="dark-red">+4 VP</strong> — Interceptor: VIP
