export const ColonyDrop = () => {
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">Mission 6 — Colony Drop</h2>
      ...
      <div className="flex-ns mb4">
        ...
        <div className="w-50-ns pl3-ns">
          ...
          <ul className="lh-copy pl3 tj">
            <li className="pv1">
              <strong className="orange">+10 VP</strong> — Attacker: Reduce
              Colony Drop Core to 0 HP
            </li>
            <li className="pv1">
              <strong className="orange">+10 VP</strong> — Defender: Colony Drop
              Core survives all 8 rounds
            </li>
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Either: Destroy enemy
              Commander MSU
            </li>
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Attacker: Deal 40+
      ...
      <p className="lh-copy">
        ...
        elevated or fortified terrain to give both sides an interesting approach
        vector. Hard Cover near the core rewards defenders.
      </p>
    </div>
  );
};
