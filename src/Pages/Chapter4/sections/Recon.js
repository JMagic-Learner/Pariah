export const Recon = () => {
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">Mission 2 — Recon</h2>
      ...
      <div className="flex-ns mb4">
        ...
        <div className="w-50-ns pl3-ns">
          ...
          <ul className="lh-copy pl3 tj">
            <li className="pv1">
              <strong className="orange">+1 VP</strong> — Forward Observe an
              enemy MSU
            </li>
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Control 3 of 5 Recon
              Points at any round end
            </li>
            <li className="pv1">
              <strong className="orange">+1 VP</strong> — Hold a Recon Point at
              end of game
            </li>
            <li className="pv1">
              <strong className="orange">+2 VP</strong> — MSU returns to
