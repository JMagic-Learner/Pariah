export const Assault = () => {
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">Mission 3 — Assault</h2>
      ...
      <div className="flex-ns mb4">
        ...
        <div className="w-50-ns pl3-ns">
          ...
          <ul className="lh-copy pl3 tj">
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Attacker holds
            ...
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Destroy enemy
              Commander MSU
            </li>
            <li className="pv1">
              <strong className="orange">+1 VP</strong> — Destroy each
              additional enemy non-Commander MSU
            </li>
            <li className="pv1">
              <strong className="orange">+3 VP</strong> — Defender: Prevent
