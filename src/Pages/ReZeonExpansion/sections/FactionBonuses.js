export const ReZeonFactionBonuses = () => {
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">ReZeon Faction Bonuses</h2>
      <p className="lh-copy mb4">
        ReZeon is an altogether separate faction from ZEON. The bonuses below
        apply to any <span className="fw6 orange"> [FIRETEAM] </span> composed
      ...
      <div className="mb5 ba b--black-20">
        <div className="bg-dark-orange pv3 ph4">
          <h3 className="f3 fw7 white ma0">General Faction Bonuses</h3>
        </div>
        <div className="pa4">
          <div className="mb3 pa3 bg-near-white ba b--black-10">
            <p className="fw7 ma0 mb1 orange">Developmental Split</p>
            <p className="lh-copy ma0 f6">
              ReZeon forces can purchase MSUs with the{" "}
              <span className="fw6 orange">[TITAN]</span> faction keyword.
              ReZeon forces cannot purchase MSUs with the Zeon keyword.
            </p>
          </div>
          <div className="mb3 pa3 bg-near-white ba b--black-10">
            <p className="fw7 ma0 mb1 orange">Unknown IFFs</p>
            <p className="lh-copy ma0 f6">
          ...
          <div className="pa3 bg-near-white ba b--black-10">
            <p className="fw7 ma0 mb1 orange">Tristellar Plan (TR Plan)</p>
            <p className="lh-copy ma0 f6">
              Units on the force list with the{" "}
              <span className="fw6 orange">[TR PROJECT]</span> keyword are
      ...
      <div className="flex-ns flex-wrap">
        ...
        <div className="w-third-ns pr3-ns mb4">
          <div className="ba b--black-20 h-100">
            ...
            <div className="pa3">
              <div className="mb3">
                <p className="fw7 ma0 mb1 orange f6">Titans Black Ops</p>
        ...
        <div className="w-third-ns pr3-ns mb4">
          <div className="ba b--black-20 h-100">
            ...
            <div className="pa3">
              <div className="mb3">
                <p className="fw7 ma0 mb1 orange f6">Cloning Project</p>
                <p className="lh-copy ma0 f7">
                  Pilots other than the{" "}
                  <span className="fw6 orange"> [COMMANDER] </span> may take the
                  same pilot traits as the{" "}
                  <span className="fw6 orange"> [FIRETEAM] </span>{" "}
                  <span className="fw6 orange"> [COMMANDER] </span>, but for one
              ...
              <div>
                <p className="fw7 ma0 mb1 orange f6">Resolute Till the End</p>
                <p className="lh-copy ma0 f7">
