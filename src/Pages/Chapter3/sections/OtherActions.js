    ...
    <div>
      ...
      <div className="bg-light-gray pa3 mb3 br2">
        ...
        <p className="lh-copy f6 mb2 tj">
          ...
          <span className="fw6 red">CAN</span> move the MSU its base movement
          speed to one of the following targets in terms of priority; if the
          Pilot fails, he / she <span className="fw6 red">MUST</span> make this
      ...
      <div className="bg-light-gray pa3 mb3 br2">
        ...
        <p className="lh-copy f6 mb0 tj">
          ...
          <span className="fw6 red"> [FIRETEAM] </span> members can move up to{" "}
          <span className="fw6 red">6 inches closer without penalty</span> to
          the <span className="fw6 red"> [COMMANDER] </span>.
        </p>
      </div>
      ...
      <div className="bg-light-gray pa3 mb3 br2">
        ...
        <p className="lh-copy f6 mb0 tj">
          ...
          <span className="fw6 red"> [COMMANDER] </span> nominates one enemy{" "}
          <span className="fw6 red"> [PILOT]</span>/MSU to be a priority target.
          <span className="fw6 red"> [FIRETEAM] </span> members within 8 inches
          may reroll .<span className="fw6 red">ALL ATTACK DICE</span> when
          targetting this priority target for one round.
        </p>
      </div>
      ...
      <div className="bg-light-gray pa3 mb3 br2">
        ...
        <p className="lh-copy f6 mb2 tj">
          ...
          <span className="fw6 red">PS 5+ Check three times</span>. For each
      ...
      <div className="bg-light-gray pa3 mb3 br2">
        ...
        <p className="lh-copy f6 mb2 i">
          ...
          <span className="fw6 red"> [READIED] </span> and which has been{" "}
          <span className="fw6 red"> [STOWED] </span>
        </p>
      </div>
