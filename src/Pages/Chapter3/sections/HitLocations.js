...
export const HitLocations = () => {
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">3.3 — Hit Locations</h2>
        ...
        <table className="f6 w-100" cellSpacing="0">
          ...
          <tbody className="lh-copy">
            {HIT_TABLE.map((row, i) => (
              ...
              >
                <td className="pv2 pr3 bb b--black-20 tc fw7 orange f5">
                  {row.roll}
                </td>
      ...
      <ol className="lh-copy pl3">
        <li className="pv1">
          ...
          <span className="fw6 orange"> [PILOT]</span> Evasion roll.
        </li>
        <li className="pv1">
