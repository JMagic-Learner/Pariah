  ...
  return (
    <div>
      ...
      <p className="lh-copy mb4">
        All ranged and melee attacks follow the same nine-step sequence. Resolve each step in
      ...
      <ul className="lh-copy pl3">
        <li className="pv1">Melee attacks require the attacking MSU to be within the weapon's range (measured from base to base).</li>
        <li className="pv1">Melee attacks use BR instead of GS for the hit roll.</li>
        <li className="pv1">Opponents in base contact may use Counterstrike weapons as a free reaction.</li>
        <li className="pv1">Melee attacks against the rear arc of an MSU add +1 hit location roll (roll 2d6, use the higher result).</li>
        <li className="pv1">BLITZ attacks add base melee weapon damage as normal; if the attacker moved 21"+ this round, Kinetic Force applies.</li>
      </ul>
        ...
        <table className="f6 w-100 collapse ba b--black-10">
          ...
          <tbody>
            {[
              ...
              ['Attacking SUPPRESSED target', 'Normal (Titans faction: +1 DAM)'],
