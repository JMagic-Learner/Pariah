  ...
  return (
    <div>
      ...
      <p className="lh-copy mb3">
        During the Movement Phase, each MSU may perform one of the following movement actions when
        activated. Movement is measured in inches from the leading edge of the base. All movement
        is declared and measured before resolution.
      </p>

      <h3 className="f4 fw7 mt3 mb2">Facing</h3>
      <p className="lh-copy mb2">
        All MSUs have a front-facing arc (180°). LOS, ranged attacks, and arc-based rules use
        this facing. Rotating to change facing costs <strong>2 inches of Move</strong> per 90°
        turned (or 1" with Inertia Redirection System). Rotation during BOOST is free.
      </p>
        ...
        <table className="f6 w-100 collapse ba b--black-10">
          ...
          <tbody>
            {[
              ...
              ['CRIPPLED Legs', 'Move halved (or -2" with Enduring Will trait)'],
      ...
      <p className="lh-copy">
        If an MSU is pushed (via Impact keyword) or falls into terrain or another MSU, it takes{' '}
        <strong>5 damage per 6 inches</strong> of distance collided (applied to the closest facing
        hit location). MSUs falling from heights greater than 12" take{' '}
        <strong>10 damage per 6" fallen</strong>, reduced to 0 with Reinforced Hydraulics support
        system. A fallen MSU gains KNOCKDOWN state.
      </p>
    </div>
  );
};
