...
export const Keywords = () => {
  ...
  return (
    <div>
      <h2 className="f2 fw7 orange bb pb2 mb3">2.11 — Keywords</h2>
        ...
        <table className="f6 w-100 collapse ba b--black-10">
          ...
          <tbody>
            {KEYWORDS.map((kw, i) => (
              ...
              >
                <td className="pa2 fw7 orange v-top nowrap">{kw.name}</td>
      ...
      <div className="w-100 h-100">
        {KEYWORDS.map((keyword, index) => (
          ...
          >
            <p className="fw7 ma0 mb1 orange f6 tc">{keyword.name}</p>
