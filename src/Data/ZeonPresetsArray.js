...
export const ZEON_PRESETS = [
    ...
    data: {
      ...
      baseEquip: [
        {
          ...
          fro: "",
          tonnage: "8",
          notes: "Shield and Gatling are in the same hand",
        },
        {
          name: "Heat Blade",
          mcuCost: "FREE",
      ...
      locations: {
        ...
        leftArm: {
          ...
          equipment: ["Shield", "Arm Cannon (INBUILT)", ""],
        },
        rightLeg: {
          current: "22",
          max: "22",
  ...
  },
  {
    ...
    data: {
      ...
      baseEquip: [
        {
          name: "Smoke Grenades x 4 (MOUNTED)",
          mcuCost: "FREE",
          fro: "",
          tonnage: "4",
          notes: "",
  ...
  },
  {
    ...
    data: {
      ...
      baseEquip: [
        ...
        {
          name: "Missile Pod 2 x 2 (INBUILT)",
          mcuCost: "FREE",
          fro: "",
          tonnage: "2",
          notes: "[INBUILT]",
  ...
  },
  {
    ...
    data: {
      ...
      baseEquip: [
        ...
        {
          name: "Missile Pod 3 x 2 (INBUILT)",
          mcuCost: "FREE",
          fro: "",
          tonnage: "4",
          notes: "[INBUILT]",
  ...
  },
  {
    ...
    data: {
      ...
      baseEquip: [
        {
          name: "Gauntlet x 2 (Extended Range)",
          mcuCost: "FREE",
          fro: "",
          tonnage: "2",
          notes: "Extended Range Gauntlets have 0-8 inch rangebands",
        },
        {
          ...
          fro: "",
          tonnage: "4",
          notes: "Essentially Knives that can be thrown and returned",
        },
        { name: "[AMPHIBIOUS]", mcuCost: "", fro: "", tonnage: "", notes: "" },
        B(),
        B(),
      ...
      locations: {
        ...
        rightArm: {
          current: "25",
          max: "25",
          weapon: "Extended Range Gauntlets",
          equipment: ["", "", ""],
        },
        leftArm: {
          current: "25",
  ...
  },
  {
    ...
    data: {
      ...
      baseEquip: [
        ...
        {
          name: "Vulcan Cannons x 2 (INBUILT)",
          mcuCost: "FREE",
          fro: "",
          tonnage: "",
          notes: "[INBUILT]",
      ...
      locations: {
        ...
        rightArm: {
          ...
          equipment: [
            "Missile Pod 10 (MOUNTED)",
            "Vulcan Cannons (INBUILT)",
            "",
          ],
        },
        leftArm: {
  ...
  },
  {
    ...
    data: {
      ...
      addlEquip: [
        {
          name: "2x Beam Cannon/Beam Sabers",
          mcuCost: "FREE",
          fro: "3/1",
          tonnage: "8",
          notes: "",
