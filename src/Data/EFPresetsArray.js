...
export const EF_PRESETS = [
  ...
  {
    id: "rgm79c-light-type-guncannon-ii",
      ...
      baseEquip: [
        {
          ...
          fro: "",
          tonnage: "6",
          notes: "[GRIP],[AP(5)] OR [AOE(6)] or [ANTI-MATERIAL]",
        },
        {
    ...
    data: {
      ...
      locations: {
        ...
        torso: {
          ...
          max: "23",
          weapon: "",
          equipment: ["Light Bazooka (Stowed)", "Beam Saber (Stowed)", ""],
        },
        rightArm: {
          current: "23",
          max: "23",
    ...
    data: {
      ...
      baseEquip: [
        ...
        },
        {
          ...
          fro: "",
          tonnage: "4",
          notes: "[AOE(6)],[QUICK SWAP],[SCOPE],[LIMITED USE(2)]",
        },
        {
          name: "Beam Saber",
          mcuCost: "FREE",
  ...
  },
  {
    ...
    faction: "EF",
    data: {
      msuName: "RGZ-95 REZEL",
      mobileSuit: "RGZ-95 REZEL",
      mcu: "190",
      fro: "7",
      tonnageLimit: "32",
      movement: '8"',
  ...
  {
    id: "rgz95-rezel Commander",
    name: "RGZ-95 REZEL Commander",
    faction: "EF",
    data: {
      msuName: "RGZ-95 REZEL Commander",
      mobileSuit: "RGZ-95 REZEL Commander",
      mcu: "210",
      fro: "8",
      tonnageLimit: "35",
      movement: '8"',
      ...
      baseEquip: [
        {
          ...
          fro: "5",
          tonnage: "6",
          notes: "[MOUNTABLE],[AP(5)] or [ANTI-MATERIAL],[LINEAR],[BRACE]",
        },
        {
          name: "Command Protocol",
          mcuCost: "FREE",
      ...
      locations: {
        ...
        torso: {
          ...
          max: "26",
          weapon: "",
          equipment: ["Heavy Boosters", "Command Protocol", ""],
        },
        rightArm: {
          current: "26",
          max: "26",
  ...
  {
    id: "FD-03 karl-gustav",
    name: "FD-03  Karl Gustav",
    faction: "EF",
    data: {
      msuName: "FD-03  Karl Gustav",
      mobileSuit: "FD-03 Karl Gustav",
      mcu: "180",
      fro: "6",
      tonnageLimit: "26",
      movement: '6"',
    ...
    data: {
      ...
      locations: {
        ...
        torso: {
          ...
          max: "24",
          weapon: "",
          equipment: ["Heavy Bazooka (Stowed)", "Beam Saber (Stowed)", ""],
        },
        rightArm: {
          current: "24",
          max: "24",
